...
// Raw mock data
const mockExpenseByCategorySummary = [
  {
    category: "Marketing",
    amount: "4000",
    date: "2025-08-01",
...
const mockExpenseSummary = {
  totalExpenses: 15500, // Could also calculate this dynamically
};
...
const CardExpenseSummary = () => {
  const expenseByCategorySummary = mockExpenseByCategorySummary;
  const expenseSummary = mockExpenseSummary;
